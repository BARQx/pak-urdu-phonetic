...
<div class="welcome-message">
  ...
  <p>The visual keyboard layout below shows which Urdu characters appear when you press different keys and modifiers (Regular, Shift, AltGr, and AltGr + Shift).</p>
